...
- [PRD.md](../../PRD.md)
- [03-ux.md](../../03-ux.md) (journeys J1–J3)
- [IA_MAP.md](../../IA_MAP.md)
- [design/TOKENS.md](../../design/TOKENS.md)

This folder is **evidence + practice synthesis**. When research and locks conflict, **locks win** until the founder changes them.
...
| # | Doc | Use when |
|---|-----|----------|
| 1 | [01-principles.md](./01-principles.md) | Core UI/UX laws (cognitive load, hierarchy, feedback) |
| 2 | [02-progressive-disclosure.md](./02-progressive-disclosure.md) | Hiding power without hiding the product |
| 3 | [03-navigation-ia.md](./03-navigation-ia.md) | Depth, labels, wayfinding, density |
...
**Power tools win when the default path is calm, depth stays shallow, labels match the job, and irreversible truth is always gated.**
...
- New visual skin / paint tokens (TOKENS.md owns that)
- New panels or a fourth ecosystem
- Replacing IA_MAP rulings
