...
export type EntryTabKey = "overview" | "timeline" | "details" | "ties";
 ...
 */
export default function EntryTabs({ tabs }: EntryTabsProps) {
  const [active, setActive] = useState<EntryTabKey>(tabs[0]?.key ?? "overview");
