// Composed gazetteer reads: the full-snapshot + single-entry-with-details
// composers. Split out of the former monolithic gazetteer.ts (T-ARCH-17);
// they build on the row reads + column fragments in reads.ts.
